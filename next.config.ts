...
const securityHeaders = [
  ...
  // Payment is allowed for Razorpay only: Checkout takes cards and UPI in its own
  // frames, and `payment=()` would switch that off inside them.
  {
    key: "Permissions-Policy",
    value: 'camera=(), microphone=(), geolocation=(), payment=(self "https://api.razorpay.com" "https://checkout.razorpay.com")',
  },
